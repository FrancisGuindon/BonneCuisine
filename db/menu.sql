...
ALTER TABLE menu_fr AUTO_INCREMENT = 1;
...
insert into menu_fr (nom, description, prix) values ('Viandes froides et Salades', 'Ce menu comprend une salade du chef, une salade de choux ainsi quune variété de viandes froides (4).', 8.25);

ALTER TABLE menu_en AUTO_INCREMENT = 1;
...
insert into menu_en (nom, description, prix) values ('Sandwichs and Salads', 'This menu includes a chefs salad, a coleslaw as well as egg, chicken and ham sandwiches.', 7.75);
insert into menu_en (nom, description, prix) values ('Cold meats and Salads', 'This menu includes a chefs salad, a coleslaw and a variety of cold meats (4).', 8.25);
